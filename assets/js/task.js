...
const task = {
    ...
    allTask: [
        { id: 1, completed: true, info: "comprare la pasta"},
        { id: 2, completed: false, info: "studiare react"},
    ],
    allTaskNodes: []
}
...
export default function() {
    showTask(true);
    task.allTaskNodes = getAllTaskNodes();
    SetEvent();
}
...
function inputEvent(e) {
    if(e.key === "Enter" && task.input.value.trim()) {
